...
def create_grs_placeholder():
    ...
    grs_structure = {
        ...
        "pillars": {
            ...
            "economic": {
                "name": "Economic Risk", 
                "weight": 0.25,
                "description": "Macroeconomic stability, trade dynamics, and institutional strength",
                "sources": ["IMF WEO", "Harvard Growth Lab", "Garriga CBI", "UNESCO", "WTO", "Harvard GSDB"],
                "variables": 9
            },
            "social": {
                "name": "Social Risk",
    ...
    for name, details in grs_structure['pillars'].items():
        print(f"  - {details['name']}: {details['variables']} variables ({details['weight']*100:.0f}% weight)")
