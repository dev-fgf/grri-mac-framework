...
class IMFWEOClient:
    ...
    def get_indicator(self, indicator_code: str, countries: List[str] = None, 
    ...
    def get_all_indicators(self, countries: List[str] = None) -> Dict[str, Any]:
...
class VDemClient:
    ...
    DATA_URL = "https://v-dem.net/static/website/files/Country_Year_V-Dem_Core_CSV_v14/V-Dem-CY-Core-v14.csv"
...
class GRRIDataAggregator:
    ...
    def calculate_grri_scores(self, raw_data: Dict[str, Any]) -> Dict[str, Dict[str, float]]:
        """
